            ...
            cell: ({ row }) => (
                <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                        {row.original.categoryName ?? 'Chưa gán danh mục'}
                    </p>
                </div>
            ),
        },
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <DataTable columns={columns} data={products} pageSize={PAGE_SIZE} showPagination={false} />
            ...
            <ConfirmDialog
                ...
                confirmText={isSubmittingAction ? 'Đang xử lý...' : confirmDialog.action === 'approve' ? 'Duyệt' : 'Ẩn tin'}
